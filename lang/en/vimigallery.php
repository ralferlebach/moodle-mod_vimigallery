...
$string['privacy:metadata'] = 'Comments users write on maps are stored. When a gallery materialises maps from another activity, the stored copies can also contain learners work and their names.';
...
$string['privacy:metadata:vimigallery_item'] = 'Copies of maps materialised from another activity, which can contain learner work.';
$string['privacy:metadata:vimigallery_item:authorname'] = 'The display name shown for the map author.';
$string['privacy:metadata:vimigallery_item:mapjson'] = 'The stored copy of the map.';
$string['privacy:metadata:vimigallery_item:sourceuserid'] = 'The learner whose work the copy derives from.';
$string['privacy:metadata:vimigallery_item_user'] = 'Which learners contributed to a materialised group map.';
$string['privacy:metadata:vimigallery_item_user:userid'] = 'A learner who contributed to the map.';
