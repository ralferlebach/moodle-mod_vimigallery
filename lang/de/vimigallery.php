...
$string['privacy:metadata:vimigallery_item_user'] = 'Welche Lernenden zu einer materialisierten Gruppen-Map beigetragen haben.';
$string['privacy:metadata:vimigallery_item_user:userid'] = 'Eine lernende Person, die zur Map beigetragen hat.';
